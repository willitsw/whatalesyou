...
// src/__tests__/exhaustive-deps.test.ts
var import_utils = require("@typescript-eslint/utils");
var import_test_utils = require("../utils/test-utils.cjs");
var import_exhaustive_deps = require("../rules/exhaustive-deps.rule.cjs");
var ruleTester = new import_utils.ESLintUtils.RuleTester({
  parser: "@typescript-eslint/parser",
  settings: {}
});
ruleTester.run("exhaustive-deps", import_exhaustive_deps.rule, {
  valid: [
    {
          ...
          suggestions: [
            {
              messageId: "fixTo",
              data: {
                result: "['foo', {dep1, dep2: dep2, bar: dep3, baz: [dep4, dep5]}, [dep6, dep7], dep8]"
              },
              output: import_test_utils.normalizeIndent`
                const todoQueries = {
                  key: (dep1, dep2, dep3, dep4, dep5, dep6, dep7, dep8) => ({
...
//# sourceMappingURL=exhaustive-deps.test.cjs.map
