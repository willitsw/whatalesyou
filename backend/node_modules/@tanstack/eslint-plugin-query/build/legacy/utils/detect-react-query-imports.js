    ...
    const helpers = {
      isSpecificTanstackQueryImport(node, source) {
        return !!tanstackQueryImportSpecifiers.find((specifier) => {
          var _a;
          if (specifier.type === TSESTree.AST_NODE_TYPES.ImportSpecifier && ((_a = specifier.parent) == null ? void 0 : _a.type) === TSESTree.AST_NODE_TYPES.ImportDeclaration && specifier.parent.source.value === source) {
